        ...
        <main>
            ...
            {submitted ? (
                <div className='flex flex-col p-10 my-10 bg-yellow-500 text-white max-w-2xl mx-auto'>
                    ...
                    <p className='mt-5'>Once it has been approved, it will appear bellow!</p>
            </div>
            ) : (
                 <form
                ...
                <label className='block mb-5'>
                    ...
                    <textarea
                        ...
                        placeholder='Nice news!'
                        rows={8} />
                </label>

                {/* Error will return when validation fails */}
            ...
            shadow shadow-yellow-500 space-y-2'>
